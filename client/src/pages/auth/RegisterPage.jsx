    ...
    <div className="h-screen w-screen flex overflow-hidden bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-16 mx-10">
        <div className="absolute top-6 right-6">
          <Button
            variant="secondary"
            className="text-primary bg-white border-primary hover:cursor-pointer"
          >
            Create Account
          </Button>
        </div>
        ...
        <label className="text-sm text-gray-700 mb-2">Email Address</label>
        <div className="relative w-72">
          <input
            type={"text"}
            className="w-full border border-gray-300 rounded-lg px-4 py-3 pr-10 text-sm outline-none focus:border-blue-500"
        ...
        <Button className="w-44 hover:cursor-pointer">Create Account</Button>
      </div>
    </div>
  );
};
